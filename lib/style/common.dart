...
/// 项目主颜色
const Color mainColor = Color(0xFFE53439);
...
class MyBorder {
  ...
  static final BoxBorder right = new Border(
    right: BorderSide(color: borderColor)
  );
  static final BoxBorder bottom = new Border(
    bottom: BorderSide(color: borderColor)
  );
  static final BoxBorder top = new Border(
    top: BorderSide(color: borderColor)
  );
  static final BoxBorder left = new Border(
    left: BorderSide(color: borderColor)
  );
