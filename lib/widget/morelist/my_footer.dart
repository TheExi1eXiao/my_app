...
class MyClassicalFooter extends Footer {
  ...
  MyClassicalFooter({
    ...
    this.noMoreText = "哦豁，撒子都没得了",
    this.showInfo: true,
    this.infoText,
    this.bgColor: Colors.transparent,
    this.textColor: grey6,
...
class MyClassicalFooterWidgetState extends State<MyClassicalFooterWidget>
  ...
  /// 文本
  String get _loadText => widget.classicalFooter.loadText;

  String get _loadReadyText => widget.classicalFooter.loadReadyText;

  String get _loadingText => widget.classicalFooter.loadingText;

  String get _loadedText => widget.classicalFooter.loadedText;

  String get _loadFailedText => widget.classicalFooter.loadFailedText;

  /// 没有更多文字
  String get _noMoreText => widget.classicalFooter.noMoreText;

  String get _infoText => widget.classicalFooter.infoText;
