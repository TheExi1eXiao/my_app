...
class MoreListState<T> extends State<MoreList> {
  ...
  void initState() {
    easyRefreshController =
        widget.easyRefreshController ?? EasyRefreshController();
  ...
  //   // 绑定控制器
  //   if (widget.moreListController != null)
  //     widget.moreListController._bindState(this);
  // }
  ...
  setRefreshModal() {
    CancelFunc _refreshModal = BotToast.showEnhancedWidget(
      ...
      warpWidget: (_, child) {
        return Container(
          // height: maxHeight - statusBarHeight - kToolbarHeight-setWidth(100),
          width: maxWidth,
  ...
  Widget build(BuildContext context) {
    ...
    return EasyRefresh(
      header: widget.useMaterialRefresh ? MaterialHeader() : FootBallFlyHeader(),
